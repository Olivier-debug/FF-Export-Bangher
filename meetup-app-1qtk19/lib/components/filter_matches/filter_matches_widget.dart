...
import 'filter_matches_model.dart';
export 'filter_matches_model.dart';

class FilterMatchesWidget extends StatefulWidget {
  const FilterMatchesWidget({super.key});

  @override
  State<FilterMatchesWidget> createState() => _FilterMatchesWidgetState();
}

class _FilterMatchesWidgetState extends State<FilterMatchesWidget> {
  late FilterMatchesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FilterMatchesModel());
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 33.0, 0.0, 20.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                  ...
                  child: Align(
                    ...
                    child: FlutterFlowChoiceChips(
                      ...
                      onChanged: (val) => safeSetState(() => _model
                          .genderOptionsChoiceChipsValue = val?.firstOrNull),
                      ...
                      controller:
                          _model.genderOptionsChoiceChipsValueController ??=
                ...
                Flexible(
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 33.0, 0.0, 20.0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
                                ...
                                await showModalBottomSheet(
                                  ...
                                  builder: (context) {
                                    return Padding(
                                      ...
                                      child: LanguageFilterBottomSheetWidget(),
                                    );
                                  },
                              ...
                              onTap: () async {
                                await showModalBottomSheet(
                                  ...
                                  builder: (context) {
                                    return Padding(
                                      padding: MediaQuery.viewInsetsOf(context),
                                      child: InterestBottomSheetWidget(),
                                    );
                                  },
                                ).then((value) => safeSetState(() {}));
                              },
                              ...
                              onTap: () async {
                                await showModalBottomSheet(
                                  ...
                                  builder: (context) {
                                    return Padding(
                                      padding: MediaQuery.viewInsetsOf(context),
                                      child: EducationBottomSheetWidget(),
                                    );
                                  },
                                ).then((value) => safeSetState(() {}));
                              },
                ...
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 50.0, 0.0, 16.0),
