...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFF1493);
  late Color secondary = const Color(0xFF5174F3);
  late Color tertiary = const Color(0xFFE5E5E5);
  late Color alternate = const Color(0xFFFFFFFF);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFEDE7E7);
  late Color primaryBackground = const Color(0xFF201F1F);
  late Color secondaryBackground = const Color(0xFF121212);
  late Color accent1 = const Color(0xFFFF3366);
  late Color accent2 = const Color(0xFFFFA366);
  late Color accent3 = const Color(0xFFE57373);
  late Color accent4 = const Color(0xFF4D4D4D);
  late Color success = const Color(0xFF66CC99);
  ...
  late Color everBlack = const Color(0xFF6A2B4D);
  late Color backdropBack = const Color(0xFF6E4040);
  late Color customColor1 = const Color(0xFF97A2DF);
}
