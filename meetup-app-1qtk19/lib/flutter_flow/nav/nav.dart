      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => ChatPageWidget(
            chatRow: params.getParam<MatchesRow>(
              'chatRow',
        ...
        FFRoute(
          name: SinglePageWidget.routeName,
          path: SinglePageWidget.routePath,
          builder: (context, params) => SinglePageWidget(
            fullProfileInfo: params.getParam(
              'fullProfileInfo',
              ParamType.JSON,
            ),
          ),
        ...
        FFRoute(
          name: TestswipestackWidget.routeName,
          path: TestswipestackWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'testswipestack')
              : TestswipestackWidget(),
        )
